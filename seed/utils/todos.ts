...
const todoTemplates = [
  ...
  },
  {
    ...
    description: "Review and provide feedback on open pull requests from team members",
  ...
  },
  {
    ...
    description: "Create slides for weekly team standup showcasing recent progress",
    priority: "medium" as const,
  },
  {
    title: "Implement dark mode toggle",
    description: "Add dark mode support to the application with user preference persistence",
    priority: "medium" as const,
  },
  {
  ...
  },
  {
    ...
    description: "Organize and schedule next sprint retrospective meeting with the team",
    priority: "low" as const,
  },
  {
...
export async function createTodoAttachments(
  ...
  // @ts-expect-error - media table is generated by snaplet seed
