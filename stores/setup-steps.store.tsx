...
const stepDefinitions: Omit<SetupStep, "completed">[] = [
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Zod schemas. Learn how database changes flow from SQL → TypeScript types
        → Zod schemas, and how seed scripts help test edge cases before
        production.
      </>
    ),
    category: "initial",
  },
  {
    ...
    description: (
      <>
        Dive into <InlineCode>server/</InlineCode> to see how Next.js App Router
        Server Actions work. This directory is{" "}
        <strong>your entire backend</strong>—think of it as your Flask server or
        Express API endpoints. Each <InlineCode>.actions.ts</InlineCode> file
        contains server-side functions for data mutations, authentication, and
        business logic. The naming convention (
        <InlineCode>.actions.ts</InlineCode>) makes fuzzy search easy and helps
        AI agents follow patterns. Check out{" "}
  ...
  },
  {
    ...
    description: (
      <>
        ...
        action best practices: (1) Always start with{" "}
        <InlineCode>"use server"</InlineCode> directive, (2) Check
        authentication and authorization, (3) Use type-safe database types from{" "}
        <InlineCode>@/types</InlineCode>, (4) Return{" "}
        ...
        frontend, making AI-assisted development much faster with excellent type
        diagnostics.
      </>
    ),
    category: "initial",
  ...
  },
  {
    ...
    description: (
      <>
        Generate professional favicons for all platforms using
        RealFaviconGenerator (<InlineCode>realfavicongenerator.net</InlineCode>
        ). Upload your logo, customize platform-specific settings, download the
        package, and install files to <InlineCode>app/</InlineCode> and{" "}
  ...
  },
  {
    ...
    description: (
      <>
        ...
        delivery with excellent developer experience and React Email
        integration.
      </>
    ),
    category: "services",
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <InlineCode>emails/utils/styles.ts</InlineCode> for the shared design
        system that ensures consistent branding across all emails. You can
        preview templates locally by running{" "}
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <InlineCode>emails/utils/styles.ts</InlineCode>. See{" "}
